...
public class SampleData {
    ...
    public static List<Car> carList =
            Arrays.asList(
                    new Car(CarMaker.CHEVROLET, "말리부", 23_000_000),
                    new Car(CarMaker.HYUNDAE, "그랜저", 23_000_000),
                    new Car(CarMaker.CHEVROLET, "트랙스", 23_000_000),
                    new Car(CarMaker.AUDI, "A6", 23_000_000),
                    new Car(CarMaker.BENZ, "E-CLASS", 23_000_000)
            );

    public static Integer[] speedOfSectionA = {100, 110, 120, 130,140};
    public static Integer[] speedOfSectionB = {80, 85, 90, 95,100};
    public static Integer[] speedOfSectionC = {90, 92, 94, 96, 98};
